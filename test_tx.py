...
def init_lora_simple():
    ...
    print("LoRa initialized with SIMPLE settings (SF7, 125kHz BW, 14dBm)")
    return True
...
def init_lora_full():
    ...
    print("LoRa initialized with FULL settings (SF12, 125kHz BW, 20dBm)")
    return True
...
def init_lora_fhss():
    ...
    print("LoRa initialized with FHSS settings (SF12, 125kHz BW, 20dBm, Freq. Hopping)")
    return True
...
def main():
    ...
    try:
        ...
        if args.mode == 'simple':
            success = init_lora_simple()
        elif args.mode == 'fhss':
            success = init_lora_fhss()
        else:  # full mode
            success = init_lora_full()
